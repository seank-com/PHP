...
class Addition
{
  ...
  private function GetNextProblem()
  {
    ...
    while($happy == FALSE)
    {
      ...
      if ($happy == TRUE)
      {
          ...
          {
          case 1: // No Carry
            $happy = $this->NoCarry($this->WP1, $this->WP2);
            break;
          case 2: // Some Carry
            if ($this->digits == 1)
            {
            ...
            {
              $happy = $this->SomeCarry($this->WP1, $this->WP2);
            }
            break;
          case 3: // All Carry
            $happy = $this->AllCarry($this->WP1, $this->WP2);
            break;
          }
      }
  ...
  public function SetLevel($level)
  {
    for($this->fractionaldigits = 0; $this->fractionaldigits <= 4; $this->fractionaldigits++)
    {
      ...
      for($this->digits = $digitsmin; $this->digits <= $digitsmax; $this->digits++)
      {
        ...
        {
          for($this->carry = 1; $this->carry <= 3; $this->carry++)
          {
            $level -= 1;
            if ($level == 0)
            {
  ...
  {
    $result = "Addition with $this->digits digit";
    if ($this->digits > 1)
    {
      $result = $result . "s ";
    }
    ...
    if ($this->digits == 1)
    {
      ...
      {
      case 1:
        $result = $result . "no 2 digit results ";
        break;
      case 2:
        $result = $result . "some 2 digit results ";
        break;
      case 3:
        $result = $result . "all 2 digit results ";
        break;
      }
    }
    else
    {
      ...
      {
      case 1:
        $result = $result . "no carrying ";
        break;
      case 2:
        $result = $result . "some carrying ";
        break;
      case 3:
        $result = $result . "lots of carrying ";
        break;
      }
    }
  ...
  public function RenderNextHorizontalProblem()
  {
    ...
    {
    case 1:
      echo "<u>&nbsp;&nbsp;&nbsp;&nbsp;</u> " . PlusSign . " $this->WP2 = $this->WPS";
      break;
    case 2:
      echo "$this->WP1 " . PlusSign . " <u>&nbsp;&nbsp;&nbsp;&nbsp;</u> = $this->WPS";
      break;
    case 3:
      echo "$this->WP1 " . PlusSign . " $this->WP2 = <u>&nbsp;&nbsp;&nbsp;&nbsp;</u>";
      break;
    }
    echo "</td></tr></table>";
  }
  ...
  public function RenderNextVerticalProblem()
  {
    ...
    echo "<tr><td class=wm>" . PlusSign . " $this->WP2</td><td class=fm>$this->FP2</td></tr>";
